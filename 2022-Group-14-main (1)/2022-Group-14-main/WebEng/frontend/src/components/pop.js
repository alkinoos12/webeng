...
//This is the component for the Popularity page
const Pop = () => {

    //These are the states for the search bar and the songs
    const [searchTerm, setSearchTerm] = useState("");
    const [songs, setSongs] = useState([]);
    const [limit, setLimit] = useState(0);

    //This is the useEffect hook that sets the limit to 10 and the songs to the songs
    useEffect(() => {
        setLimit(10);
        setSongs(songs);
    }, []);
    ...
    //This is the search function that searches for the song by popularity
